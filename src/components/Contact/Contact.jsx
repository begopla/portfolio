...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard("begonapr@gmail.com");
        ...
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            <Box as="h2" fontSize="3xl" fontWeight="600" mt="8vh">
              <span className="about-heading">CONTACT ME</span>
            </Box>
            <Stack
            ...
            >
              ...
              >
                ...
                <Link href="https://github.com/begopla">
                  <IconButton
                    aria-label="github"
                    variant="ghost"
                    size="lg"
                ...
                <Link href="https://www.linkedin.com/in/begonaplarubio">
                  <IconButton
                    aria-label="linkedin"
                    variant="ghost"
                    size="lg"
